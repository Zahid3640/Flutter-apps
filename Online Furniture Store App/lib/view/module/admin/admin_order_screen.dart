...
import '../../widget/admin_receipt.dart';
...
class AdminOrderScreen extends StatefulWidget {
 final String id;
   AdminOrderScreen({Key? key,required this.id}) : super(key: key);
                  ...
                  builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    ...
                    return  ListView(
                        ...
                        children: snapshot.data!.docs.map((DocumentSnapshot document) {
                          ...
                          data["order"]["products"].forEach((v) {
                            product.add(Products.fromJson(v));
                          });
                          return
                            AdminReceipt(temp: temp,  id: document.id, date: data["order"]["time"], totalPrice: data["order"]["totalPrice"], totalProduct: data["order"]["totalProduct"],status:data["order"]["status"],shoppingProductList:product,uid: widget.id );
                        }).toList());
                  }
              ),
            ],
